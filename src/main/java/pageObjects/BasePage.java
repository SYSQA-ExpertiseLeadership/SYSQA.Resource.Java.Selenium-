...
abstract class BasePage {
	...
	public BasePage() {
		/*
		 * Iedere pagina moet de browser kunnen beinvloeden. vandaar dat we hier in de
		 * 'BasePage' een referentie naar de driver vastleggen. In iedere klasse die
		 * BasePage extend kunnen we nu de '_driver' variabele gebruiken
		 */
